...
const seedEvents: EventItem[] = [
  {
    ...
    image: EVENT_IMAGES[0], organizer: 'DJ Luna', organizerId: 'seed1', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Luna', isPrivate: false, isDraft: false, requiresApproval: false,
  ...
  },
  {
    ...
    image: EVENT_IMAGES[1], organizer: 'TechCorp', organizerId: 'seed2', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=TechCorp', isPrivate: false, isDraft: false, requiresApproval: true,
  ...
  },
  {
    ...
    image: EVENT_IMAGES[2], organizer: 'FoodieClub', organizerId: 'seed3', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Foodie', isPrivate: false, isDraft: false, requiresApproval: false,
  ...
  },
  {
    ...
    image: EVENT_IMAGES[3], organizer: 'ZenMaster', organizerId: 'seed4', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Zen', isPrivate: false, isDraft: false, requiresApproval: false,
  ...
  },
  {
    ...
    image: EVENT_IMAGES[4], organizer: 'ArtCollective', organizerId: 'seed5', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Art', isPrivate: false, isDraft: false, requiresApproval: false,
    reviews: [], reports: [], collaborators: [],
  },
  {
    ...
    image: EVENT_IMAGES[5], organizer: 'BeatDrop', organizerId: 'seed6', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Beat', isPrivate: false, isDraft: false, requiresApproval: false,
  ...
  },
  {
    ...
    image: EVENT_IMAGES[6], organizer: 'StartupHub', organizerId: 'seed7', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Startup', isPrivate: false, isDraft: false, requiresApproval: false,
    reviews: [], reports: [], collaborators: [],
  },
  {
    ...
    image: EVENT_IMAGES[7], organizer: 'PixelKing', organizerId: 'seed8', organizerAvatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Pixel', isPrivate: false, isDraft: false, requiresApproval: true,
