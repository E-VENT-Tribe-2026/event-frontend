...
const seedEvents: EventItem[] = [
  {
    ...
    image: EVENT_IMAGES[0], organizer: 'DJ Luna', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Luna', isPrivate: false,
    reviews: [{ user: 'Alex', text: 'Amazing vibes!', rating: 5 }],
  },
  {
    ...
    image: EVENT_IMAGES[1], organizer: 'TechCorp', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=TechCorp', isPrivate: false,
    reviews: [{ user: 'Sam', text: 'Very insightful talks.', rating: 4 }],
  },
  {
    ...
    image: EVENT_IMAGES[2], organizer: 'FoodieClub', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Foodie', isPrivate: false,
    reviews: [],
  },
  {
    ...
    image: EVENT_IMAGES[3], organizer: 'ZenMaster', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Zen', isPrivate: false,
    reviews: [{ user: 'Mia', text: 'So peaceful!', rating: 5 }],
  },
  {
    ...
    image: EVENT_IMAGES[4], organizer: 'ArtCollective', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Art', isPrivate: false,
    reviews: [],
  },
  {
    ...
    image: EVENT_IMAGES[5], organizer: 'BeatDrop', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Beat', isPrivate: false,
    reviews: [{ user: 'Jake', text: 'Best party ever!', rating: 5 }],
  },
  {
    ...
    image: EVENT_IMAGES[6], organizer: 'StartupHub', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Startup', isPrivate: false,
    reviews: [],
  },
  {
    ...
    image: EVENT_IMAGES[7], organizer: 'PixelKing', organizerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Pixel', isPrivate: false,
    reviews: [{ user: 'Chris', text: 'Nostalgia overload!', rating: 4 }],
  },
];
